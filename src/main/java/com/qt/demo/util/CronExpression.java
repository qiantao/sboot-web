...
public final class CronExpression implements Serializable, Cloneable {
        ...
        try {
            ...
            while (exprsTok.hasMoreTokens() && exprOn <= YEAR) {
                ...
                if(exprOn == DAY_OF_WEEK && expr.indexOf('#') != -1 && expr.indexOf('#', expr.indexOf('#') +1) != -1) {
                    throw new ParseException("Support for specifying multiple month days is not implemented.", -1);
                }
    ...
    public static Date getNextExecTime(String cron){
        boolean validExpression = isValidExpression(cron);
        if(!validExpression){
            return null;
        }
